...
package com.common.core.view.htmlview;
...
public class HtmlRemoteImageGetter implements ImageGetter {
    ...
    public class ImageGetterAsyncTask extends AsyncTask<String, Void, Drawable> {
        ...
        public Drawable fetchDrawable(String urlString) {
            try {
                ...
                LogInfo.log("geny", drawable.getIntrinsicWidth() + "--------------" + drawable.getIntrinsicHeight());
    ...
    public class UrlDrawable extends BitmapDrawable {
        ...
        public UrlDrawable(){
            drawable = c.getResources().getDrawable(R.drawable.image_loading_in_text_24);
            drawable.setBounds(0, 0, drawable.getIntrinsicWidth(), drawable.getIntrinsicHeight());
            this.setBounds(getDefaultImageBounds(c));
        }
