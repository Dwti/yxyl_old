...
public class ExamAnalyContainer extends LinearLayout implements Observer {
    ...
    private void createLeftValueContainer() {
        ...
        for(int i=0;i<divide-1;i++){
            if(totalValue>0){
                ...
                LayoutParams textParams=new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, itemHeight);
    ...
    private List<ChartBarEntity> convertDataToChart(ExamListInfo info) {
          List<ChartBarEntity> charList=new ArrayList<>();
...
//
//        ChartBarEntity entity7=new ChartBarEntity();
//        entity7.setTitle("我我我我我我我我我我我我我我我我我我");
//        entity7.setDataElement(new DataElement(87.0f, BarChartPanel.platterTable[0]));
//
//        ChartBarEntity entity8=new ChartBarEntity();
//        entity8.setTitle("我我我我我我我我我我我我我我我我我我");
//        entity8.setDataElement(new DataElement(87.0f, BarChartPanel.platterTable[0]));
//
//        ChartBarEntity entity9=new ChartBarEntity();
//        entity9.setTitle("我我我我我我我我我我我我我我我我我我");
//        entity9.setDataElement(new DataElement(87.0f, BarChartPanel.platterTable[0]));
//
//
//        ChartBarEntity entity10=new ChartBarEntity();
//        entity10.setDataElement(new DataElement(87.0f, BarChartPanel.platterTable[0]));
//        entity10.setTitle("我我我我我我我我我我我我我我我我我我");
//
//        ChartBarEntity entity11=new ChartBarEntity();
//        entity11.setDataElement(new DataElement(87.0f, BarChartPanel.platterTable[0]));
//        entity11.setTitle("我我我我我我我我我我我我我我我我我我");
//
//        ChartBarEntity entity12=new ChartBarEntity();
//        entity12.setDataElement(new DataElement(87.0f, BarChartPanel.platterTable[0]));
//        entity12.setTitle("我我我我我我我我我我我我我我我我我我");
//
//        ChartBarEntity entity13=new ChartBarEntity();
//        entity13.setDataElement(new DataElement(87.0f, BarChartPanel.platterTable[0]));
//        entity13.setTitle("我我我我我我我我我我我我我我我我我我");
//
//
//
//
...
//        charList.add(entity7);
//        charList.add(entity8);
//        charList.add(entity9);
//        charList.add(entity10);
//        charList.add(entity11);
//        charList.add(entity12);
//        charList.add(entity13);
