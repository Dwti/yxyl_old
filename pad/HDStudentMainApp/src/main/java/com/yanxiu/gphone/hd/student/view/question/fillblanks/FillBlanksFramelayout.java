...
//        float xAxisRight =  layout.getSecondaryHorizontal(index);//字符右边x坐标  (yAxisBottom - 5 - yAxisTop + tvFillBlank.getTextSize() / 2)
        ...
        if(bean!=null && String.valueOf(YanXiuConstant.SUBJECT.YINYU).equals(bean.getSubjectId())){
            if(CommonCoreUtil.getSDK() >= 21){
                params = new RelativeLayout.LayoutParams((int) ((tvFillBlank.getTextSize() /2) *
                        15), (int) (yAxisBottom - yAxisTop + tvFillBlank.getTextSize()));
                params.topMargin = (int) (yAxisTop - tvFillBlank.getTextSize() / 2);
            }else{
                params = new RelativeLayout.LayoutParams((int) ((tvFillBlank.getTextSize() /2) *
                        15), (int) (yAxisBottom - yAxisTop + tvFillBlank.getTextSize()*3/4));
                params.topMargin = (int) (yAxisTop - tvFillBlank.getTextSize() / 2 - 5);
            }
        }else{
            if(CommonCoreUtil.getSDK() >= 21){
                params = new RelativeLayout.LayoutParams((int) ((tvFillBlank.getTextSize() /2) *
                ...
                params = new RelativeLayout.LayoutParams((int) ((tvFillBlank.getTextSize() /2) * 15), (int) (yAxisBottom - yAxisTop + tvFillBlank.getTextSize()*3/4));
                params.topMargin = (int) (yAxisTop - tvFillBlank.getTextSize() / 2 - 5);
            }
        }
