package com.yanxiu.gphone.hd.student.view.passwordview;
...
public class GridPasswordView extends LinearLayout implements PasswordView {
    ...
    private void initAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (textSize != -1) {
            this.textSize = CommonCoreUtil.px2sp(textSize);
        }

        lineWidth = (int) ta.getDimension(R.styleable.gridPasswordView_lineWidth, CommonCoreUtil.dipToPx(1));
    ...
    private TextWatcher textWatcher = new TextWatcher() {
        ...
        public void onTextChanged(CharSequence s, int start, int before, int count) {
            ...
            if (newStr.length() == 1) {
                ...
                inputView.setText(Html.fromHtml("<strong>" + passwordArr[0] +
                        "</strong>"));
