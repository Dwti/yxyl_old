...
public class FavouriteSectionFragment extends TopBaseFragment   implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        mFg= (MyCollectContainerFragment) getParentFragment();
        mPublicLayout= PublicLoadUtils.createPage(getActivity(), R.layout.fragment_favourite_section_layout);
        findView();
        initData();
...
//                        }
    ...
    public void onEventMainThread (UpdateCollectBean updateBean) {
        if(updateBean==null){
            return;
        }
