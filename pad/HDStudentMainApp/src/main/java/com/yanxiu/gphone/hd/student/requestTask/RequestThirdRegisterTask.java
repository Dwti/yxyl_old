...
public class RequestThirdRegisterTask extends AbstractAsyncTask<UserInfoBean>{
    ...
    public RequestThirdRegisterTask(Context context, String openid,
    ...
    public YanxiuDataHull<UserInfoBean> doInBackground() {
        YanxiuDataHull<UserInfoBean> dataHull = YanxiuHttpApi.requestThirdRegister(nickName, sex,headimg,openid,pltform,deviceId,realname,provinceid,schoolname,schoolid,
