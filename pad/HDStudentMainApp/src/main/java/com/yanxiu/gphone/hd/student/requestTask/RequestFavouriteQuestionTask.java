...
public class RequestFavouriteQuestionTask extends AbstractAsyncTask<SubjectExercisesItemBean>{
    ...
    public RequestFavouriteQuestionTask(Context context, String stageId, String subjectId, String editionId,
                                        String chapterId, String sectionId, String volumeId, int currentPage, String currentId, String cellId, int
                                                ptype,
    ...
    public YanxiuDataHull<SubjectExercisesItemBean> doInBackground() {
        return YanxiuHttpApi.requestFavouriteQuestion(0, stageId, subjectId, editionId, volumeId, chapterId, sectionId, pageSize, currentPage,
