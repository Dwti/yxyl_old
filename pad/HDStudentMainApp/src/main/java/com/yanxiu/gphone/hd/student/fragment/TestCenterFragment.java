...
import com.yanxiu.gphone.hd.student.requestTask.RequestKnpTask;
...
public class TestCenterFragment extends AbsChapterFragment {
    ...
    public void requestData() {
        ...
        requestChapterListTask = new RequestKnpTask(this.getActivity(), stageId,
                subjectId, new AsyncCallBack() {
            @Override
