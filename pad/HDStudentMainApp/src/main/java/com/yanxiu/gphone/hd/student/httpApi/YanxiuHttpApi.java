package com.yanxiu.gphone.hd.student.httpApi;
...
import com.yanxiu.gphone.hd.student.parser.UploadFileParser;
import com.yanxiu.gphone.hd.student.parser.UploadImageParser;
...
//        LogInfo.log("geny", "请求结束标志 -- sb" + sb2.toString());
    ...
    public static <T extends YanxiuBaseBean, D> YanxiuDataHull<T> requestThirdLoginUserInfo(String openid,
            String platfor, YanxiuMainParser<T, D> parser) {
    ...
    public static <T extends YanxiuBaseBean, D> YanxiuDataHull<T> requestThirdRegister(String nickName,
            String sex,String headimg,String openid,String pltform,String deviceId,String realname,
