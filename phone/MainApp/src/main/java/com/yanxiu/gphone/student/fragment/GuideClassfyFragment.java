...
public class GuideClassfyFragment extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view=inflater.inflate(R.layout.layout_guide_classfy_question,null);
        ImageView iv_guide_classfy_gesture = (ImageView)view.findViewById(R.id.iv_guide_classfy_gesture);
        Glide.with(GuideClassfyFragment.this)
