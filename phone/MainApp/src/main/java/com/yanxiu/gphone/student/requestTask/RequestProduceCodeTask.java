 ...
 */
public class RequestProduceCodeTask extends AbstractAsyncTask<RequestBean>{
    private AsyncCallBack mAsyncCallBack;
    private String mobile;
    private int type;
    public RequestProduceCodeTask(Context context, String mobile,
    ...
    public YanxiuDataHull<RequestBean> doInBackground() {
        return YanxiuHttpApi.requestProduceGetCode(0,mobile,type,new RequestParser());
    }
