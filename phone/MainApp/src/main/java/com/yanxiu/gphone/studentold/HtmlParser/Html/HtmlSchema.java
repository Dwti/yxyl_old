...
public class HtmlSchema extends Schema {
	...
	public HtmlSchema() {
		...
		elementType("a", M_PCDATA| Utils.M_NOLINK, Utils.M_INLINE, 0);
		elementType("abbr", M_PCDATA|Utils.M_INLINE, Utils.M_INLINE|Utils.M_NOLINK, F_RESTART);
		elementType("acronym", M_PCDATA|Utils.M_INLINE, Utils.M_INLINE|Utils.M_NOLINK, F_RESTART);
		elementType("address", M_PCDATA|Utils.M_INLINE|Utils.M_P, Utils.M_BLOCK, 0);
		elementType("applet", M_PCDATA|Utils.M_PARAM|Utils.M_INLINE|Utils.M_BLOCK, Utils.M_INLINE|Utils.M_NOLINK, 0);
		elementType("area", M_EMPTY, Utils.M_AREA, 0);
		elementType("b", M_PCDATA|Utils.M_INLINE, Utils.M_INLINE|Utils.M_NOLINK, F_RESTART);
		elementType("base", M_EMPTY, Utils.M_HEAD, 0);
		elementType("basefont", M_EMPTY, Utils.M_INLINE|Utils.M_NOLINK, 0);
		elementType("bdo", M_PCDATA|Utils.M_INLINE, Utils.M_INLINE|Utils.M_NOLINK, F_RESTART);
		elementType("bgsound", M_EMPTY, Utils.M_HEAD, 0);
		elementType("big", M_PCDATA|Utils.M_INLINE, Utils.M_INLINE|Utils.M_NOLINK, F_RESTART);
		elementType("blink", M_PCDATA|Utils.M_INLINE, Utils.M_INLINE|Utils.M_NOLINK, F_RESTART);
		elementType("blockquote", M_PCDATA|Utils.M_INLINE|Utils.M_BLOCK, Utils.M_BLOCK, 0);
		elementType("body", M_PCDATA|Utils.M_INLINE|Utils.M_BLOCK, Utils.M_HTML|Utils.M_BODY, 0);
		elementType("br", M_EMPTY, Utils.M_INLINE|Utils.M_NOLINK, 0);
		elementType("button", M_PCDATA|Utils.M_INLINE|Utils.M_BLOCK, Utils.M_INLINE|Utils.M_NOLINK, 0);
		elementType("canvas", M_PCDATA|Utils.M_INLINE, Utils.M_INLINE|Utils.M_NOLINK, 0);
		elementType("caption", M_PCDATA|Utils.M_INLINE, Utils.M_TABULAR, 0);
		elementType("center", M_PCDATA|Utils.M_INLINE|Utils.M_BLOCK, Utils.M_BLOCK, 0);
		elementType("cite", M_PCDATA|Utils.M_INLINE, Utils.M_INLINE|Utils.M_NOLINK, F_RESTART);
		elementType("code", M_PCDATA|Utils.M_INLINE, Utils.M_INLINE|Utils.M_NOLINK, F_RESTART);
		elementType("col", M_EMPTY, Utils.M_COL|Utils.M_TABULAR, 0);
		elementType("colgroup", Utils.M_COL, Utils.M_TABULAR, 0);
		elementType("comment", M_PCDATA|Utils.M_INLINE, Utils.M_INLINE|Utils.M_NOLINK, 0);
		elementType("dd", M_PCDATA|Utils.M_INLINE|Utils.M_BLOCK, Utils.M_DEF, 0);
		elementType("del", M_PCDATA|Utils.M_INLINE|Utils.M_BLOCK, Utils.M_INLINE|Utils.M_BLOCKINLINE|Utils.M_BLOCK, F_RESTART);
		elementType("dfn", M_PCDATA|Utils.M_INLINE, Utils.M_INLINE|Utils.M_NOLINK, F_RESTART);
		elementType("dir", Utils.M_LI, Utils.M_BLOCK, 0);
		elementType("div", M_PCDATA|Utils.M_INLINE|Utils.M_BLOCK, Utils.M_BLOCK, 0);
		elementType("dl", Utils.M_DEF, Utils.M_BLOCK, 0);
		elementType("dt", M_PCDATA|Utils.M_INLINE, Utils.M_DEF, 0);
		elementType("em", M_PCDATA|Utils.M_INLINE, Utils.M_INLINE|Utils.M_NOLINK, F_RESTART);
		elementType("fieldset", M_PCDATA|Utils.M_LEGEND|Utils.M_INLINE|Utils.M_BLOCK, Utils.M_BLOCK, 0);
		elementType("font", M_PCDATA|Utils.M_INLINE, Utils.M_INLINE|Utils.M_NOLINK, 0);
		elementType("form", M_PCDATA|Utils.M_INLINE|Utils.M_NOLINK|Utils.M_BLOCK|Utils.M_TR|Utils.M_CELL, Utils.M_BLOCK|Utils.M_FORM, F_NOFORCE);
		elementType("frame", M_EMPTY, Utils.M_FRAME, 0);
		elementType("frameset", Utils.M_FRAME, Utils.M_FRAME|Utils.M_HTML, 0);
		elementType("h1", M_PCDATA|Utils.M_INLINE, Utils.M_BLOCK, 0);
		elementType("h2", M_PCDATA|Utils.M_INLINE, Utils.M_BLOCK, 0);
		elementType("h3", M_PCDATA|Utils.M_INLINE, Utils.M_BLOCK, 0);
		elementType("h4", M_PCDATA|Utils.M_INLINE, Utils.M_BLOCK, 0);
		elementType("h5", M_PCDATA|Utils.M_INLINE, Utils.M_BLOCK, 0);
		elementType("h6", M_PCDATA|Utils.M_INLINE, Utils.M_BLOCK, 0);
		elementType("head", Utils.M_HEAD, Utils.M_HTML, 0);
		elementType("hr", M_EMPTY, Utils.M_BLOCK, 0);
		elementType("html", Utils.M_HTML, M_ROOT, 0);
		elementType("i", M_PCDATA|Utils.M_INLINE, Utils.M_INLINE|Utils.M_NOLINK, F_RESTART);
		elementType("iframe", M_PCDATA|Utils.M_INLINE|Utils.M_BLOCK, Utils.M_INLINE|Utils.M_NOLINK, 0);
		elementType("img", M_EMPTY, Utils.M_INLINE|Utils.M_NOLINK, 0);
		elementType("input", M_EMPTY, Utils.M_INLINE|Utils.M_NOLINK, 0);
		elementType("ins", M_PCDATA|Utils.M_INLINE|Utils.M_BLOCK, Utils.M_INLINE|Utils.M_BLOCK, F_RESTART);
		elementType("isindex", M_EMPTY, Utils.M_HEAD, 0);
		elementType("kbd", M_PCDATA|Utils.M_INLINE, Utils.M_INLINE|Utils.M_NOLINK, F_RESTART);
		elementType("label", M_PCDATA|Utils.M_INLINE, Utils.M_INLINE|Utils.M_NOLINK, 0);
		elementType("legend", M_PCDATA|Utils.M_INLINE, Utils.M_LEGEND, 0);
		elementType("li", M_PCDATA|Utils.M_INLINE|Utils.M_BLOCK, Utils.M_LI, 0);
		elementType("link", M_EMPTY, Utils.M_HEAD|Utils.M_INLINE, 0);
		elementType("listing", M_PCDATA|Utils.M_INLINE, Utils.M_BLOCK, 0);
		elementType("map", Utils.M_BLOCK|Utils.M_AREA, Utils.M_INLINE, 0);
		elementType("marquee", M_PCDATA|Utils.M_INLINE, Utils.M_INLINE|Utils.M_NOLINK, 0);
		elementType("menu", Utils.M_LI, Utils.M_BLOCK, 0);
		elementType("meta", M_EMPTY, Utils.M_HEAD, 0);
		elementType("nobr", M_PCDATA|Utils.M_INLINE, Utils.M_INLINE|Utils.M_NOLINK, 0);
		elementType("noframes", Utils.M_BODY|Utils.M_BLOCK|Utils.M_INLINE, Utils.M_BLOCK|Utils.M_HTML|Utils.M_FRAME, 0);
		elementType("noscript", M_PCDATA|Utils.M_INLINE|Utils.M_BLOCK, M_ANY & ~M_ROOT, 0);
		elementType("object", M_PCDATA|Utils.M_PARAM|Utils.M_INLINE|Utils.M_BLOCK, Utils.M_HEAD|Utils.M_INLINE|Utils.M_NOLINK, 0);
		elementType("ol", Utils.M_LI, Utils.M_BLOCK, 0);
		elementType("optgroup", Utils.M_OPTIONS, Utils.M_OPTIONS, 0);
		elementType("option", M_PCDATA, Utils.M_OPTION|Utils.M_OPTIONS, 0);
		elementType("p", M_PCDATA|Utils.M_INLINE|Utils.M_TABLE, Utils.M_BLOCK|Utils.M_P, 0);
		elementType("param", M_EMPTY, Utils.M_PARAM, 0);
		elementType("pre", M_PCDATA|Utils.M_INLINE, Utils.M_BLOCK, 0);
		elementType("q", M_PCDATA|Utils.M_INLINE, Utils.M_INLINE|Utils.M_NOLINK, F_RESTART);
		elementType("rb", M_PCDATA|Utils.M_INLINE, Utils.M_INLINE|Utils.M_NOLINK, F_RESTART);
		elementType("rbc", M_PCDATA|Utils.M_INLINE, Utils.M_INLINE|Utils.M_NOLINK, F_RESTART);
		elementType("rp", M_PCDATA|Utils.M_INLINE, Utils.M_INLINE|Utils.M_NOLINK, F_RESTART);
		elementType("rt", M_PCDATA|Utils.M_INLINE, Utils.M_INLINE|Utils.M_NOLINK, F_RESTART);
		elementType("rtc", M_PCDATA|Utils.M_INLINE, Utils.M_INLINE|Utils.M_NOLINK, F_RESTART);
		elementType("ruby", M_PCDATA|Utils.M_INLINE, Utils.M_INLINE|Utils.M_NOLINK, F_RESTART);
		elementType("s", M_PCDATA|Utils.M_INLINE, Utils.M_INLINE|Utils.M_NOLINK, F_RESTART);
		elementType("samp", M_PCDATA|Utils.M_INLINE, Utils.M_INLINE|Utils.M_NOLINK, F_RESTART);
		elementType("script", M_PCDATA, M_ANY & ~M_ROOT, F_CDATA);
		elementType("select", Utils.M_OPTIONS, Utils.M_INLINE, 0);
		elementType("small", M_PCDATA|Utils.M_INLINE, Utils.M_INLINE|Utils.M_NOLINK, F_RESTART);
		elementType("span", M_PCDATA|Utils.M_INLINE, Utils.M_INLINE|Utils.M_NOLINK, 0);
		elementType("strike", M_PCDATA|Utils.M_INLINE, Utils.M_INLINE|Utils.M_NOLINK, F_RESTART);
		elementType("strong", M_PCDATA|Utils.M_INLINE, Utils.M_INLINE|Utils.M_NOLINK, F_RESTART);
		elementType("style", M_PCDATA, Utils.M_HEAD|Utils.M_INLINE, F_CDATA);
		elementType("sub", M_PCDATA|Utils.M_INLINE, Utils.M_INLINE|Utils.M_NOLINK, F_RESTART);
		elementType("sup", M_PCDATA|Utils.M_INLINE, Utils.M_INLINE|Utils.M_NOLINK, F_RESTART);
		elementType("table", Utils.M_FORM|Utils.M_TABULAR, Utils.M_BLOCK|Utils.M_TABLE, F_NOFORCE);
		elementType("tbody", Utils.M_TR, Utils.M_TABULAR, 0);
		elementType("td", M_PCDATA|Utils.M_INLINE|Utils.M_BLOCK, Utils.M_CELL, 0);
		elementType("textarea", M_PCDATA, Utils.M_INLINE, 0);
		elementType("tfoot", Utils.M_TR|Utils.M_FORM|Utils.M_CELL, Utils.M_TABULAR, 0);
		elementType("th", M_PCDATA|Utils.M_INLINE|Utils.M_BLOCK, Utils.M_CELL, 0);
		elementType("thead", Utils.M_TR|Utils.M_FORM|Utils.M_CELL, Utils.M_TABULAR, 0);
		elementType("title", M_PCDATA, Utils.M_HEAD, 0);
		elementType("tr", Utils.M_FORM|Utils.M_CELL, Utils.M_TR|Utils.M_TABULAR, 0);
		elementType("tt", M_PCDATA|Utils.M_INLINE, Utils.M_INLINE|Utils.M_NOLINK, F_RESTART);
		elementType("u", M_PCDATA|Utils.M_INLINE, Utils.M_INLINE|Utils.M_NOLINK, F_RESTART);
		elementType("ul", Utils.M_LI, Utils.M_BLOCK, 0);
		elementType("var", M_PCDATA|Utils.M_INLINE, Utils.M_INLINE|Utils.M_NOLINK, 0);
		elementType("wbr", M_EMPTY, Utils.M_INLINE|Utils.M_NOLINK, 0);
		elementType("xmp", M_PCDATA|Utils.M_INLINE, Utils.M_BLOCK, 0);
		parent("<pcdata>", "body");
		parent("html", "<root>");
		parent("a", "body");
		parent("abbr", "body");
