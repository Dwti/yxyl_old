...
import com.yanxiu.gphone.studentold.bean.PublicVolumeBean;
import com.yanxiu.gphone.studentold.bean.SubjectEditionBean;
import com.yanxiu.gphone.studentold.fragment.AbsChapterFragment;
import com.yanxiu.gphone.studentold.fragment.MistakeChapterFragment;
import com.yanxiu.gphone.studentold.inter.AsyncLocalCallBack;
import com.yanxiu.gphone.studentold.parser.SubjectEditionParser;
import com.yanxiu.gphone.studentold.requestTask.RequestEditionInfoTask;
import com.yanxiu.gphone.studentold.requestTask.RequestMistakeSectionTask;
import com.yanxiu.gphone.studentold.utils.PublicLoadUtils;
import com.yanxiu.gphone.studentold.view.ChapterTabTitleLayout;
import com.yanxiu.gphone.studentold.view.PublicLoadLayout;
import com.yanxiu.gphone.studentold.view.SortPopUpWindow;
import com.yanxiu.gphone.studentold.view.TitleTabLayout;
...
public class MistakeSectionActivity extends YanxiuBaseActivity implements View.OnClickListener {
    ...
    private boolean hasChapterMistakeQus = true;//是否有章节错题
    //=======================================================
    ...
    public static void launch (Activity activity, String title, String subjectId, String editionId, ArrayList<DataTeacherEntity> volumeIdList, int
            has_knp) {
        Intent intent = new Intent(activity, MistakeSectionActivity.class);
    ...
    public void onCreate (Bundle savedInstanceState) {
        ...
        mRootView = PublicLoadUtils.createPage(this, R.layout.activity_mistake_section_layout);
        ...
        if (volumeIdList != null && volumeIdList.size() > 0) {
            ...
            hasChapterMistakeQus = true;
        } else {
            hasChapterMistakeQus = false;
        }
        findView();
        initData();
    }
    ...
    public void hideAndShowFragment (int index) {
        ...
        switch (currItem) {
            case AbsChapterFragment.CHAPTER:
                isChapterSection = 0;
                if (hasChapterMistakeQus && topRightView.getVisibility() != View.VISIBLE) {
                    topRightView.setVisibility(View.VISIBLE);
                }
                if (chapterFragment == null) {
    ...
    private PublicSubjectBaseBean createPublicSubjectBaseBean () {
        ...
        mBean.setHasChapterFavQus(hasChapterMistakeQus);
    ...
    protected void onActivityResult (int requestCode, int resultCode, Intent data) {
        if (resultCode == RESULT_OK) {
            if (requestCode == WrongAnswerViewActivity.WRONG_ANSWER_REQUESTCODE && data != null) {
