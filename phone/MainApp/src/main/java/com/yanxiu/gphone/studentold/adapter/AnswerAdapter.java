...
import com.yanxiu.gphone.studentold.fragment.FillFragment;
import com.yanxiu.gphone.studentold.fragment.question.BaseQuestionFragment;
import com.yanxiu.gphone.studentold.fragment.question.ChoiceQuestionFragment;
import com.yanxiu.gphone.studentold.fragment.question.ClassfyQuestionFragment;
import com.yanxiu.gphone.studentold.fragment.question.ConnectFragment;
import com.yanxiu.gphone.studentold.fragment.question.JudgeQuestionFragment;
import com.yanxiu.gphone.studentold.fragment.question.QuestionFragmentFactory;
import com.yanxiu.gphone.studentold.fragment.question.SubjectiveQuestionFragment;
...
import com.yanxiu.gphone.studentold.view.question.readquestion.InterViewPager;
...
public class AnswerAdapter extends FragmentPagerAdapter implements QuestionsListener {
    ...
    private final static int NOT_FINISH_STATUS = 1;//未完成 不可补做  查看解析报告
    ...
    public boolean isHomeWorkFinished(boolean isHomeWorkFinished) {
        return this.isFinshed = isHomeWorkFinished;
    }
...
//			isWrongSet = bean.isWrongSet();
            ...
            if (!isFinshed) {
                for (PaperTestEntity paperTestEntity : dataList) {
                    paperTestEntity.setHomeWorkFinished(false);
                }
            }
