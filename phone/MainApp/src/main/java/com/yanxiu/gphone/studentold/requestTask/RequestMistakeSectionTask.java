...
import com.yanxiu.gphone.studentold.parser.SectionMistakeBeanParser;

/**
 * Created by Administrator on 2015/6/1.
 */
public class RequestMistakeSectionTask extends AbstractAsyncTask<SectionMistakeBean> {
    ...
    private int ptype;
    public RequestMistakeSectionTask(Context context, String stageId, String subjectId, String beditionId, String volume, int ptype,
    ...
    public YanxiuDataHull<SectionMistakeBean> doInBackground() {
        return YanxiuHttpApi.requestSectionMistake(0, stageId, subjectId, beditionId, volume, ptype, new SectionMistakeBeanParser());
    }
