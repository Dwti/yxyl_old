...
public class GuideClassfyQuestionView extends FrameLayout {
    ...
    private ImageView iv_guide_classfy_gesture;
...
//                    .into(iv_guide_first_gesture);
                .into(new GlideDrawableImageViewTarget(iv_guide_classfy_gesture, 1));
    }
    ...
    private void initView(){
        ...
        View view = LayoutInflater.from(mContext).inflate(R.layout.layout_guide_classfy_question, this);
         iv_guide_classfy_gesture = (ImageView)view.findViewById(R.id.iv_guide_classfy_gesture);
