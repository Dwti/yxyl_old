 ...
 */
public class ConnectConverter implements ContentHandler {
    ...
    public ConnectConverter(Context context, String source, ImageGetterListener imageGetterListener, MyHtml.TagHandler tagHandler, HtmlParser parser, Object object, ImageSpanOnclickListener listener) {
