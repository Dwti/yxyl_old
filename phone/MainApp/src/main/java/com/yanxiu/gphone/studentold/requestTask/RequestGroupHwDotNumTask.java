...
import com.yanxiu.gphone.studentold.parser.GroupHwwaitFinishBeanParser;
...
public class RequestGroupHwDotNumTask extends AbstractAsyncTask<GroupHwwaitFinishBean>{
    ...
    public YanxiuDataHull<GroupHwwaitFinishBean> doInBackground() {
        return YanxiuHttpApi.requestGroupWaitfinishHwkNum(
                new GroupHwwaitFinishBeanParser());
    }
