package com.yanxiu.gphone.student.HtmlParser.Html;

import com.yanxiu.gphone.student.HtmlParser.Interface.ScanHandlerListener;
import com.yanxiu.gphone.student.HtmlParser.Interface.ScannerListener;
 ...
 */
public class HtmlScannerListener implements ScannerListener, Locator {
    ...
    public void scan(Reader r0, ScanHandlerListener h) throws IOException, SAXException {
        theState = S_PCDATA;
        PushbackReader r;
        ...
        while (theState != S_DONE) {
            ...
            switch (action) {
                case 0:
                    throw new Error("HtmlScannerListener can't cope with " + Integer.toString(ch) + " in state " + Integer.toString(theState));
                case A_ADUP:
    ...
    private void save(int ch, ScanHandlerListener h) throws IOException, SAXException {
    ...
    public static void main(String[] argv) throws IOException, SAXException {
        ScannerListener s = new HtmlScannerListener();
        Reader r = new InputStreamReader(System.in, "UTF-8");
        Writer w = new OutputStreamWriter(System.out, "UTF-8");
        HtmlPYXWriter pw = new HtmlPYXWriter(w);
        s.scan(r, pw);
        w.close();
    }
