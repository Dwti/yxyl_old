...
public class GroupListAdapter extends YXiuCustomerBaseAdapter<GroupBean>{
    ...
    @Override public View getView(int position, View convertView,
        ...
        if(convertView == null){
            ...
            RelativeLayout.LayoutParams params = new RelativeLayout.LayoutParams(CommonCoreUtil.dipToPx(50),
                    CommonCoreUtil
                    .dipToPx(18));
            params.leftMargin = CommonCoreUtil.dipToPx(15);
...
////            holder.info.setText(mContext.getResources().getString(R.string.group_item_info,paperBean.getName()));
