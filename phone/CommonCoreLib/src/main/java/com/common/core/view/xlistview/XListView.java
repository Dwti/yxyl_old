...
//    private TextView mHeaderTimeView;
    ...
    private void initWithContext(Context context) {
        ...
        // init header view
        mHeaderView = getHeaderView(context);
...
//                .findViewById(R.id.xlistview_header_time);
        ...
        // init footer view
        mFooterView = getFootView(context);
...
//                if(getLastVisiblePosition() == mTotalItemCount - 1 && mEnablePullLoad){
    ...
    protected XListViewHeaderNew getHeaderView(Context context){
        return new XListViewHeaderNew(context);
    }
...
//                }
        ...
        if (mScroller.computeScrollOffset()) {
            if (mScrollBack == SCROLLBACK_HEADER) {
                ...
                if(mScroller.getCurrY()<=0){
                    mHeaderView.setState(XListViewHeaderNew.STATE_DONE);
                }
    ...
    public interface IXListViewListener {
        void onRefresh(XListView view);

        void onLoadMore(XListView view);
    }
