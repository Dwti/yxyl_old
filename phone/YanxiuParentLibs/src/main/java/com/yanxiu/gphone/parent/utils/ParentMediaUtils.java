 ...
 */
public class ParentMediaUtils {
    private static  final String TAG=ParentMediaUtils.class.getSimpleName();
    //打开系统相册的requestCode
    ...
    private static File getOutputMediaFile(boolean isNewFile) {
        ...
        try {
            ...
            mediaStorageDir = new File(YanxiuParentConstants.SDCARD_ROOT_PATH, TEMP_UPLOAD_PIC_DIR);
            e.printStackTrace();
        } finally {
