 ...
 */
public class RequestParentUpdateInfoTask extends AbstractAsyncTask<ParentRequestBean>{
    private AsyncCallBack mAsyncCallBack;
    private HashMap<String, String> paramsMap;
    public RequestParentUpdateInfoTask(Context context, HashMap<String, String> paramsMap, AsyncCallBack mAsyncCallBack) {
        super(context);
    ...
    public YanxiuDataHull<ParentRequestBean> doInBackground() {
        return YanxiuParentHttpApi.requestUpdateUserInfo(new ParentRequestParser(), paramsMap);
    }
