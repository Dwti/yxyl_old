 ...
 */
public class RequestParentUploadFeedBackTask extends AbstractAsyncTask<ParentRequestBean>{

    private AsyncCallBack mAsyncCallBack;
    private String content;

    public RequestParentUploadFeedBackTask(Context context, String content, AsyncCallBack mAsyncCallBack) {
        super(context);
    ...
    public YanxiuDataHull<ParentRequestBean> doInBackground() {
        return YanxiuParentHttpApi.requestUploadFeedBack(content, new ParentRequestParser());
    }
